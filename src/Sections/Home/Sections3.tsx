                    ...
                    <div className="flex gap-[24px]">
                      <div>
                        ...
                        <div className="flex items-center gap-[8px] mb-5">
                          {
                            item.agencyServices.map((serviceItem, serviceIndex) => {
                              return (
                                <div key={serviceIndex} className="flex justify-center bg-[#3364F7] items-center gap-[8px] h-[38px] pr-[9px] max-w-fit rounded-tl-xl rounded-bl-md rounded-tr-md rounded-br-xl">
                  ...
                  <div className="border-t-[1px]">
                    <div className="grid grid-cols-12 justify-between">
                      ...
                      <div className="flex items-center justify-center col-span-3 px-2 py-2 h-[56px]">
                        <RatingStars rating={item.rating} /> <span className="text-[16px] font-bold">{item.avgRating}</span>
                      </div>
                    </div>
                  </div>
                  </div>
